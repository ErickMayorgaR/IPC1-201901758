...
public class Utilidades {
    ...
    public static JLabel posicionesLabelAs(JLabel elemento) {
        ...
        while (elemento.getX() == rayoLabel.getX() || elemento.getX() == caracolLabel.getX() || elemento.getX() == corazonLabel.getX() || elemento.getX() == ojoLabel.getX()) {
   ...
   public static JLabel posicionesLabelCora(JLabel elemento) {
        ...
        while (elemento.getX() == rayoLabel.getX() || elemento.getX() == caracolLabel.getX() ||elemento.getX() == ojoLabel.getX()||elemento.getX() == asteroideLabel.getX()) {
            int a=(int)(Math.random()*5);
            elemento.setBounds((0 + (100 * a)),elemento.getY(),100,100);
      ...
      public static JLabel posicionesLabelCarac(JLabel elemento) {
        ...
        while (elemento.getX() == rayoLabel.getX()|| elemento.getX() == corazonLabel.getX() || elemento.getX() == ojoLabel.getX()||elemento.getX() == asteroideLabel.getX()) {
            int a=(int)(Math.random()*5);
            elemento.setBounds((0 + (100 * a)),elemento.getY(),100,100);
        ...
        while (elemento.getX() == caracolLabel.getX() || elemento.getX() == corazonLabel.getX() || elemento.getX() == ojoLabel.getX()||elemento.getX() == asteroideLabel.getX()) {
            int a=(int)(Math.random()*5);
            elemento.setBounds((0 + (100 * a)),elemento.getY(),100,100);
        ...
        while (elemento.getX() == rayoLabel.getX() || elemento.getX() == caracolLabel.getX() || elemento.getX() == corazonLabel.getX()||elemento.getX() == asteroideLabel.getX()) {
            int a=(int)(Math.random()*5);
            elemento.setBounds((0 + (100 * a)),elemento.getY(),100,100);
    ...
    public static JLabel CreaAsteroideLabel() {
     ...
     public static JLabel CreaCohete() {
      ...
      public static JButton CreaNave() {
        ...
        Nombre.setBounds(200, 555, 100, 100);
