 ...
 */
public class ListaCircularVista extends JFrame{
    JTextArea codigoG;
    public JPanel panelInterfaz;
    
     public ListaCircularVista() throws HeadlessException {
        IniciarComponentes();
    ...
    public void ColocarOtros() {
        ...
        panelInterfaz.add(eliminarButton);
         ...
         String contenido= lCircularDatos.generagraph();        
        ...
        codScroll.setBounds(20, 20, 300, 300);
         ...
         ActionListener agregarListener=new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                AgregarLCircular alC=new AgregarLCircular(codigoG);
         ...
         ActionListener eliminarListener=new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                 EliminarCircular eL =new EliminarCircular(codigoG);   
