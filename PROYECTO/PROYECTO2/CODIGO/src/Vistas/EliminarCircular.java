...
import static Controladores.DatosTablero.lCircularDatos;
 ...
 */
public class EliminarCircular extends JFrame {
    JTextArea cod;
       public JPanel panelInterfaz;
    
     public EliminarCircular(JTextArea codField) throws HeadlessException {
         cod=codField;
        IniciarComponentes();
        ...
        panelInterfaz.add(valorField);
         ...
         ActionListener agregarListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                lCircularDatos.eliminarNodo((agregarValor));
                cod.setText(lCircularDatos.generagraph());
