...
import static Controladores.DatosTablero.colaDatos;
 ...
 */
public class AgregarCola extends JFrame {
     JTextArea cod;
       public JPanel panelInterfaz;
    
     public AgregarCola(JTextArea codField) throws HeadlessException {
         cod=codField;
        IniciarComponentes();
        ...
        panelInterfaz.add(valorField);
         ...
         ActionListener agregarListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                colaDatos.encolar((agregarValor));
                cod.setText(colaDatos.generagraph());
