...
public class ControlDatosautomoviles {
    ...
    public static void Modeloenlista(JComboBox lista) {
      ...
      public static void Mecanicaenlista(JComboBox lista) {
        lista.removeAllItems();
        for (int i = 0; i < Tarreglos; i++) {
            if (mecanicas[i] != null) {
                lista.addItem(mecanicas[i]);
            }
        }
    }
      
        public static void Repuestoenlista(JComboBox lista) {
        lista.removeAllItems();
        for (int i = 0; i < Tarreglos; i++) {
            if (repuestos[i] != null) {
                lista.addItem(repuestos[i]);
            }
        }
    }
